...
public class Patient
{
	...
	{
		return "Patient [ID=" + ID + ", MRN=" + MRN + ", fullName=" + fullName + ", gender=" + gender + ", dob=" + dob + ", height=" + height + ", weight="
				+ weight + ", admitDate=" + admitDate + ", location=" + location + ", roomNumber=" + roomNumber + ", attendingPhysician=" + attendingPhysician
